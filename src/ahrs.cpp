...
#ifndef ROS_ERROR
#define ROS_ERROR(s) std::cout << s << std::endl;
#endif
...
void AHRS::update(double gx, double gy, double gz, double ax, double ay, double az, double mx, double my, double mz, double dt) {
    double recipNorm;
    double s0, s1, s2, s3;
...
void AHRS::update(double gx, double gy, double gz, double ax, double ay, double az, double dt) {
    double recipNorm;
    double s0, s1, s2, s3;
    double qDot1, qDot2, qDot3, qDot4;
...
double AHRS::invSqrt(const double x){
    return 1.0/sqrt(x);
}
